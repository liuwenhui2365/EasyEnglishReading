...
import com.example.liu.autotanslate.ViewPagerAdapter;

import java.util.ArrayList;
import java.util.HashMap;


public class Classify extends Activity implements AdapterView.OnItemClickListener {
...
//                      startActivity(intent);
                  ...
                  case 2:
                      ...
                      break;
                  case 3:
                      intent = new Intent(Classify.this,UserTranslate.class);
                      startActivity(intent);
                      break;
                  case 4:
